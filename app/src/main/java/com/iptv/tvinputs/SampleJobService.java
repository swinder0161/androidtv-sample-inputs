...
public class SampleJobService extends EpgSyncWithAdsJobService {
    ...
    private String MPEG_DASH_CHANNEL_NUMBER = "1";
    ...
    private String TEARS_OF_STEEL_SOURCE = "https://delta45tatasky.akamaized.net/out/i/554.mpd";
    ...
    public List<Channel> getChannels() {
        Log.i("swidebug", "> SampleJobService getChannels()");
        // Add channels through an XMLTV file
        Log.i("swidebug", ". SampleJobService getChannels() add from xml");
        List<Channel> channelList = new ArrayList<>();
        /*XmlTvParser.TvListing listings = RichFeedUtil.getRichTvListings(this);
        channelList.addAll(listings.getChannels());*/

        Log.i("swidebug", ". SampleJobService getChannels() add ad");
        ...
        Log.i("swidebug", ". SampleJobService getChannels() add from program");
    ...
    public List<Program> getOriginalProgramsForChannel(Uri channelUri, Channel channel,
        ...
        Log.i("swidebug", "> SampleJobService getOriginalProgramsForChannel()");
        Log.i("swidebug", ". SampleJobService getOriginalProgramsForChannel() channelUri: " + channelUri);
        Log.i("swidebug", ". SampleJobService getOriginalProgramsForChannel() channel: " + channel);
        Log.i("swidebug", ". SampleJobService getOriginalProgramsForChannel() time: " + startMs + " - " + endMs);
        if (!channel.getDisplayName().equals(MPEG_DASH_CHANNEL_NAME)) {
            ...
            Log.i("swidebug", "< SampleJobService getOriginalProgramsForChannel() xml");
            return null;
            ...
            InternalProviderData internalProviderData = new InternalProviderData();
            //internalProviderData.setVideoType(Util);
            internalProviderData.setVideoUrl("ts42");
            ...
            programsTears.add(new Program.Builder()
                    ...
                    .setInternalProviderData(internalProviderData)
                    .build());
            Log.i("swidebug", "< SampleJobService getOriginalProgramsForChannel() program");
